...
function loadNode(a,b){$.ajax({type:"POST",url:"/node/paginate",data:{cmd:"node_main",node:a,node_name:b},dataType:"json",error:onError,success:function(b){"success"==b.response&&($("#node_container").empty(),$("#node_container").append(b.html),$(document).ready(function(){initNode(a);loadPosts(a,"")}))}})}
