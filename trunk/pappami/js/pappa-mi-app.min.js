...
function onOpenNotifications(a){var b={cmd:"ntfy_summary"};"false"==$("#ntf_cnt").attr("data-visible")&&$.ajax({type:"POST",url:"/ntfctn/paginate",data:b,dataType:"json",error:onError,success:function(b){var d=$("#ntf_cnt");d.attr("data-content",b.html);d.popover("show");d.attr("data-visible","true");$(".s_glob_ntfy").text("0");$(".s_glob_ntfy").removeClass("badge-warning");a.preventDefault()}})}function addAttach(){var a=$(this),b=a.clone();b.appendTo(a.parent());b.change(addAttach)}
