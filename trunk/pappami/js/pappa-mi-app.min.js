...
function onChannelMessage(a){a=jQuery.parseJSON(a.data);var b="";if("message"==a.type)b="<strong>"+a.user+"</strong>: "+a.body;else if("post"==a.type||"comment"==a.type)getNotificationsNum(),b=a.user+' ha aggiunto un <a href="'+a.source_uri+'">'+a.source_desc+'</a> su <a href="'+a.target_uri+'">'+a.target_desc+"</a>";$.pnotify({title:"Notifica",text:b})}var tiny_mce_opts={width:"100%",autoresize_min_height:100,theme:"modern",plugins:"autolink,autoresize,link,image,media",menubar:!1,statusbar:!1,toolbar:"bold italic underline strikethrough | bullist numlist | link image media | undo redo"};
